                ...
                <div className='div3'>
                    <div className='div22'>
                        ...
                        <div className='showpasswordinput'>
                            <input name="password" type={passwordShown ? "text" : "password"} onChange={Onchange} placeholder="password" className='inpt' />
                            <img src={img4} alt="eye" className='eye-svg hoverpointer' onClick={togglePassword} />
                        </div>
